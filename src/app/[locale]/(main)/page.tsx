...
> = {
  ...
  Elite: {
    ...
    borderColor: "border-pf-pink/30 hover:border-pf-pink/60",
    badgeClass: "bg-pf-pink/10 text-pf-pink border-pf-pink/20",
    isPopular: true,
    gradientFrom: "from-pf-pink/10",
  },
  Master: {
            ...
            <div className="grid grid-cols-1 lg:grid-cols-[55fr_45fr] gap-12 xl:gap-20 items-center min-h-[calc(100vh-56px)] py-20">
              ...
              <div>
                ...
                >
                  <Link
                    href="/challenges"
                    className="press animate-cta-ripple group relative inline-flex items-center gap-2 px-7 py-3.5 rounded bg-pf-pink hover:bg-pf-pink-dark text-white font-semibold text-[14px] transition-colors duration-200 overflow-hidden"
                  >
                  ...
                  <Link
                    href="/how-it-works"
                    className="inline-flex items-center gap-2 px-7 py-3.5 rounded border border-border text-muted-foreground hover:border-pf-brand/30 hover:text-foreground font-semibold text-[14px] transition-all duration-200"
                  >
                ...
                >
                  {proofStats.map(({ value, key }, i) => (
                    <div
                      key={key}
                      className={`shrink-0 ${i < proofStats.length - 1 ? "pr-7 mr-7 border-r border-border" : ""}`}
                    >
                      <AnimatedCounter
                        value={value}
              ...
              >
                ...
                <div className="animate-float relative bg-card border border-pf-brand/20 rounded-lg shadow-[0_2px_8px_rgba(0,0,0,0.4),0_8px_32px_rgba(0,0,0,0.3)] p-7">
                  {/* Card header */}
                  ...
                  {/* Sparkline */}
                  <div className="mb-4 bg-secondary rounded overflow-hidden">
                    <svg
                      viewBox="0 0 300 60"
                  ...
                  <div className="flex justify-between items-center mb-2">
                    <span className="font-mono text-[9px] text-muted-foreground uppercase tracking-[0.08em]">
                      {t("demo_progress_label")}
                    </span>
                    <span className="font-mono text-[9px] text-muted-foreground">
                      72%
                    </span>
                  </div>
                  <div className="h-[2px] bg-border rounded mb-5">
        ...
        <section className="py-24 bg-card border-t border-border relative overflow-hidden">
          ...
          <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="text-center mt-10">
              <Link
                href="/challenges"
                className="press inline-flex items-center gap-2 px-8 py-3.5 rounded-xl bg-pf-pink hover:bg-pf-pink-dark text-white font-bold text-sm shadow-pf-pink-glow hover:shadow-pf-pink-glow-lg transition-all duration-300 hover:-translate-y-0.5 group"
              >
                {t("tiers_cta")}
            ...
            <div className="flex flex-wrap justify-center gap-3 mb-6">
              {sports.map((s) => {
                ...
                return (
                  <div
                    key={s.name}
                    className="flex items-center gap-2.5 px-5 py-2.5 rounded-xl border border-border bg-transparent hover:border-pf-brand/30 hover:bg-pf-brand/5 transition-all duration-200 group cursor-default"
                  >
        ...
        <section className="py-20 bg-background border-t border-border">
          <div className="mx-auto max-w-5xl px-4 sm:px-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 auto-rows-[minmax(160px,auto)]">
              ...
              {/* Two-phase system */}
              <GlowingCard glowColor="201,168,76">
                <div className="h-full p-6 rounded-2xl border border-border hover:border-pf-brand/25 bg-gradient-to-b from-card to-transparent transition-colors duration-300 group">
                  <div className="flex items-center justify-center w-10 h-10 rounded-xl border bg-secondary border-border text-muted-foreground mb-4">
