  ...
  if (requests.length === 0) {
    return (
      <p className="text-sm text-muted-foreground py-8 text-center">
        No market requests in this status.
      </p>
    );
  }
          ...
          {r.status === "pending" && (
            <div className="flex flex-wrap gap-2">
              ...
              <button
                ...
                disabled={pending}
                className="text-xs px-3 py-2 rounded-lg border border-blue-500/30 text-blue-400 hover:bg-blue-500/10 transition-colors disabled:opacity-50"
              >
                Mark Reviewed
              </button>
              <button
                ...
                disabled={pending}
                className="text-xs px-3 py-2 rounded-lg bg-pf-pink text-white font-semibold hover:bg-pf-pink-dark transition-colors disabled:opacity-50"
              >
                Approve
              </button>
              <button
                ...
                disabled={pending}
                className="text-xs px-3 py-2 rounded-lg border border-red-500/30 text-red-400 hover:bg-red-500/10 transition-colors disabled:opacity-50"
              >
                Reject
              </button>
            </div>
